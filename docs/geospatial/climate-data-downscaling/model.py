...
class QuantileDownscaler(nn.Module):
    """
    QuantileDownscaler network.
    ...
    """
    def __init__(self, in_channels=3, num_channels=64, num_blocks=16, quantiles=[0.05, 0.5, 0.95]):
        super().__init__()
        ...
        self.final = nn.Conv2d(num_channels, len(quantiles), kernel_size=9, stride=1, padding=4)
